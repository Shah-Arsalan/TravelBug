...
export const videos = [
  {
    _id: "iDN7xlv3xxM",
    title: "Abandoned in paris with no money for 24 hours",
    description:
    ...
    img: "https://i.ytimg.com/vi/YT7tQzmGRLA/0.jpg",
    comments: [
      {
        user: "Bablu Trailor",
        comment:
  ...
  {
    _id: "c3BRTlHFpBU",
    title: "Inside Rio’s favelas, the city's neglected neighborhoods",
    description:
    ...
    comments: [
      ...
      },
      {
        user: "Roma Bulani",
        comment:
          "The Alchemist is a great book for a short read. Love your choices!",
        color: "brown",
      },
    ],
  },
  {
    _id: "l3EjdcwDAqI",
    title: "Throwing a Dart at a Map and Flying Wherever it Lands...",
    description:
  ...
  {
    _id: "Mp-v65Fl9HM",
    title: "What Can $100 Get in VIETNAM (World's Cheapest Country)",
    creator: "Brett Conti",
    description:
  ...
  {
    _id: "OrJ4rPSlrlI",
    title: "Last City in Europe with No Laws",
    description:
    ...
    comments: [
      ...
      },
      {
        user: "Roma Bulani",
        comment:
          "Just found your channel today. What an amazing job you are doing here!",
        color: "brown",
      },
    ],
  },
  {
    _id: "r5Ps1TZXAN8",
    title: "How this border transformed a subcontinent | India & Pakistan",
    description:
      "Yo Yo Yo! Make sure you suggest some of your favourite books to me too! Lemme kno you liked the books from this video! LoveLove!",
    creator: "Vox",
    category: "Others",
    ...
    comments: [
      {
        user: "Bablu Trailor",
        comment:
          "Hello Ankur sir, I would love to read a book that taught you courage!",
        color: "hotpink",
      },
      {
        user: "Roma Bulani",
  ...
  {
    _id: "7AqAs0YizkY",
    title: "4 Days in the WORLD'S COLDEST CITY (-40C) | Yakutsk, Russia",
    description:
  ...
  {
    _id: "he-aCCA2ONI",
    title: "Europe - 12 countries in 24 days | Cinematic Travel",
    description:
    ...
    comments: [
      {
        user: "Bablu Trailor",
        comment:
          "Your Future Is Created By What You Do Today, Not Tomorrow. ~ Rich Dad Poor Dad",
        color: "hotpink",
      },
      {
        user: "Roma Bulani",
